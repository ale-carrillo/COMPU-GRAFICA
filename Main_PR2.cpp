...
int main() {
	...
	//  P R O Y E C C I O N  O R T O G O N A L
	...
	//	// A C O M O D O  D E  F I G U R A S
	...
	// _______________________________________________________________________________________________________________________________________
		...
		// P R O Y E C C I O N  P E R S P E C T I V A
		...
		while (!glfwWindowShouldClose(window))
		{
			...
			view = glm::translate(view, glm::vec3(0.0f, 0.0f, -10.0f)); // Con la proyección en perspectiva
