...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::translate(model, glm::vec3(-2.5f, 6.5f, 1.5f));
		...
		// t r o m p a
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-1.875f, 1.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.75f, 0.30f, 0.50f));
		model = glm::rotate(model, glm::radians(270.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
		...
		// p a t i t a 1
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-1.0f, -1.0f, -0.60f));
