...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "P R A C T I C A 4", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// En la matriz temp guardo la ultima parte de la fig
		...
		////Dedo 4
		model = glm::translate(modelTemp2, glm::vec3(0.25f, -0.35f, 0.375f));
		model = glm::rotate(model, glm::radians(dedo1), glm::vec3(0.0f, -1.0, 0.0f));
		modelTemp = model = glm::translate(model, glm::vec3(0.5f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 0.3f, 0.25f));
		color = glm::vec3(0.0f, 1.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
